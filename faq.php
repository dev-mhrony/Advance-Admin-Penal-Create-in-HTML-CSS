            ...
            <div class="content-wrapper">
                ...
                <div class="content">
                    ...
                    <h4 class="text-center content-group">
                        All FAQ questions and answered
                        <small class="display-block">Am if number no up period regard sudden better. Decisively
                            surrounded all
                            admiration</small>
                    </h4>
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-heading">
                                        <h6 class="panel-title">
                                            <a class="collapsed" data-toggle="collapse" href="#question1">
                                                <i class="icon-help position-left text-slate"></i> A without walking
                                                some objective?
                                            </a>
                                        </h6>
                                    </div>
                                    ...
                                    <div id="question1" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            She exposed painted fifteen are noisier mistake led waiting. Surprise not
                                            wandered speedily
                                            husbands although yet end. Are court tiled cease young built fat one man
                                            taken. We highest ye
                                            friends is exposed equally in. Ignorant had too strictly followed.
                                            Astonished as travelling
                                            assistance or unreserved oh pianoforte ye. Five with seen put need tore add
                                            neat.
                                        </div>
                                        ...
                                        <div class="panel-footer panel-footer-transparent">
                                            ...
                                            <ul class="pull-right">
                                                <li><a href="#"><i class="icon-thumbs-up2 position-left"></i></a> 320
                                                </li>
                                    ...
                                    <form action="#">
                                        <div class="input-group content-group">
                                            ...
                                            <div class="input-group-btn">
                                                <button type="submit" class="btn btn-primary btn-lg btn-icon"><i
